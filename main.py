...
def get_proxylist(type):
    if type == "SOCKS5":
        r = requests.get("https://flashproxy.io/api/public/proxy/9c36acf4-581e-4ba3-8380-0d12f3f0d389?country=US&count=1&protocol=HTTP&type=Rotating&pool=All&format=ipup").text
        r += requests.get("https://flashproxy.io/api/public/proxy/9c36acf4-581e-4ba3-8380-0d12f3f0d389?country=US&count=1&protocol=HTTP&type=Rotating&pool=All&format=ipup").text
